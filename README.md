...
- Power BI (DAX, dashboard design, interactivity)  
...
- Combines **SQL + Python + Power BI** (not just dashboarding)  
- Uses **YTD vs PYTD analytics for real business context**  
- Applies **segmentation and drill-down for decision-making**  
- Designed for **executive-level insights and usability**  
